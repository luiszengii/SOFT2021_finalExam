...
set CLASSPATH=%APP_HOME%\lib\SCD2_2021_Exam-1.0-SNAPSHOT.jar;%APP_HOME%\lib\json-simple-1.1.1.jar;%APP_HOME%\lib\jackson-databind-2.0.1.jar;%APP_HOME%\lib\sqlite-jdbc-3.7.2.jar;%APP_HOME%\lib\junit-4.10.jar;%APP_HOME%\lib\jackson-annotations-2.0.1.jar;%APP_HOME%\lib\jackson-core-2.0.1.jar;%APP_HOME%\lib\hamcrest-core-1.1.jar

@rem Execute SCD2_2021_Exam
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SC_D2_2021_EXAM_OPTS%  -classpath "%CLASSPATH%" MainApp %CMD_LINE_ARGS%
